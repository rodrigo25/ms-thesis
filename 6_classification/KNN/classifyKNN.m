...
%
function [Acc, knnModels] = classifyKNN(eeg, y, c, parameters, channels, print_on)
  ...
  for k=parameters % Numero de vizinhos do knn
    ...
    knnModels{count} = fitcknn(X,y,'NumNeighbors',k,'Distance','euclidean'); % Treina modelo com todos os dados
